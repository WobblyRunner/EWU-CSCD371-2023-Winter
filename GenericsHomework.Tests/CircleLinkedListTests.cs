...
public class CircleLinkedListTests
{
	...
	public void Node_Append_ThrowsInvalidOperationExceptionOnDuplicateNotRoot()
	{
		Node<int> root = new(0);
		const int value = 42;
	...
	[TestMethod]
	[ExpectedException(typeof(InvalidOperationException))]
	public void Node_Append_ThrowsInvalidOperationExceptionOnDuplicateRootValue()
	{
		const int value = 100;
		Node<int> root = new(value);
	...
	[TestMethod]
	[ExpectedException(typeof(InvalidOperationException))]
	public void Node_AppendRange_ThrowsInvalidOperationExceptionOnDuplicate()
	{
		Node<int> root = new(0);
